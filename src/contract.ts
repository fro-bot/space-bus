...
// discovery.ts's attach-path re-validation. `new URL(...).hostname` never
// includes brackets around an IPv6 literal, so "[::1]" never matches
// anything in practice — kept out here rather than copied as dead weight.
